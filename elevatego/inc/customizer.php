 ...
 * @since Twenty Sixteen 1.0
 *
 * @see elv_twentysixteen_header_style()
 */
function elv_twentysixteen_custom_header_and_background() {
	$color_scheme             = elv_twentysixteen_get_color_scheme();
	...
	add_theme_support( 'custom-header', apply_filters( 'twentysixteen_custom_header_args', array(
		...
		'height'                 => 280,
		'flex-height'            => true,
		'wp-head-callback'       => 'elv_twentysixteen_header_style',
	) ) );
}
add_action( 'after_setup_theme', 'elv_twentysixteen_custom_header_and_background' );

if ( ! function_exists('elv_twentysixteen_header_style') ) :
/**
 ...
 * @since Twenty Sixteen 1.0
 *
 * @see elv_twentysixteen_custom_header_and_background().
 */
function elv_twentysixteen_header_style() {
 ...
 */
function elv_twentysixteen_customize_register( $wp_customize ) {
	$color_scheme = elv_twentysixteen_get_color_scheme();
	...
	$wp_customize->add_control( 'color_scheme', array(
		...
		'section'  => 'colors',
		'type'     => 'select',
		'choices'  => elv_twentysixteen_get_color_scheme_choices(),
		'priority' => 1,
	) );
 ...
 * @see elv_twentysixteen_customize_register()
 *
 * @return void
 */
function elv_twentysixteen_customize_partial_blogname() {
	bloginfo( 'name' );
}
 ...
 * @return void
 */
function elv_twentysixteen_customize_partial_blogdescription() {
 ...
 */
function elv_twentysixteen_get_color_schemes() {
	/**
...
if ( ! function_exists('elv_twentysixteen_get_color_scheme') ) :
/**
 ...
 */
function elv_twentysixteen_get_color_scheme() {
	$color_scheme_option = get_theme_mod( 'color_scheme', 'default' );
	$color_schemes       = elv_twentysixteen_get_color_schemes();
...
if ( ! function_exists('elv_twentysixteen_get_color_scheme_choices') ) :
/**
 ...
 */
function elv_twentysixteen_get_color_scheme_choices() {
	$color_schemes                = elv_twentysixteen_get_color_schemes();
...
if ( ! function_exists('elv_twentysixteen_sanitize_color_scheme') ) :
/**
 ...
 */
function elv_twentysixteen_sanitize_color_scheme( $value ) {
	$color_schemes = elv_twentysixteen_get_color_scheme_choices();
 ...
 */
function elv_twentysixteen_color_scheme_css() {
	$color_scheme_option = get_theme_mod( 'color_scheme', 'default' );
	...
	$color_textcolor_rgb = elv_twentysixteen_hex2rgb( $color_scheme[3] );
	...
	$color_scheme_css = elv_twentysixteen_get_color_scheme_css( $colors );

	wp_add_inline_style( 'twentysixteen-style', $color_scheme_css );
}
add_action( 'wp_enqueue_scripts', 'elv_twentysixteen_color_scheme_css' );
 ...
 * @since Twenty Sixteen 1.0
 */
function elv_twentysixteen_customize_control_js() {
	...
	wp_localize_script( 'color-scheme-control', 'colorScheme', elv_twentysixteen_get_color_schemes() );
}
 ...
 * @since Twenty Sixteen 1.0
 */
function elv_twentysixteen_customize_preview_js() {
 ...
 */
function elv_twentysixteen_get_color_scheme_css( $colors ) {
 ...
 * @since Twenty Sixteen 1.0
 */
function elv_twentysixteen_color_scheme_css_template() {
	$colors = array(
	...
	<script type="text/html" id="tmpl-twentysixteen-color-scheme">
		<?php echo elv_twentysixteen_get_color_scheme_css( $colors ); ?>
	</script>
	<?php
}
add_action( 'customize_controls_print_footer_scripts', 'elv_twentysixteen_color_scheme_css_template' );
 ...
 * @see wp_add_inline_style()
 */
function elv_twentysixteen_page_background_color_css() {
	$color_scheme          = elv_twentysixteen_get_color_scheme();
...
add_action( 'wp_enqueue_scripts', 'elv_twentysixteen_page_background_color_css', 11 );
 ...
 * @see wp_add_inline_style()
 */
function elv_twentysixteen_link_color_css() {
	$color_scheme    = elv_twentysixteen_get_color_scheme();
...
add_action( 'wp_enqueue_scripts', 'elv_twentysixteen_link_color_css', 11 );
 ...
 * @see wp_add_inline_style()
 */
function elv_twentysixteen_main_text_color_css() {
	$color_scheme    = elv_twentysixteen_get_color_scheme();
	...
	// Convert main text hex color to rgba.
	$main_text_color_rgb = elv_twentysixteen_hex2rgb( $main_text_color );
...
add_action( 'wp_enqueue_scripts', 'elv_twentysixteen_main_text_color_css', 11 );
 ...
 * @see wp_add_inline_style()
 */
function elv_twentysixteen_secondary_text_color_css() {
	$color_scheme    = elv_twentysixteen_get_color_scheme();
...
add_action( 'wp_enqueue_scripts', 'elv_twentysixteen_secondary_text_color_css', 11 );
