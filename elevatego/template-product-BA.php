...
while ($loop->have_posts()) : $loop->the_post();
	...
	if ($all_product_categories[0]->name == 'Bank Accounts') {
					...
					<ul class="list-unstyled list-inline pull-right">
						...
						<li>
							<a id="liveagent_button_online_57328000000Kz6n_cta" href="javascript://Chat" style="display: none;" onclick="liveagent.startChat('57328000000Kz6n')" class="h5"> Live chat
								<img src="<?php echo esc_url( get_theme_mod('live_chat_image') ); ?>" class="img-circle chat-thumbnail" width="50" height="50"></a>
