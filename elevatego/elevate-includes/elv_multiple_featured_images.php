...
if (class_exists('MultiPostThumbnails')) {
    ...
    new MultiPostThumbnails(array(
        'label' => 'Persona 9 Image',
        'id' => 'secondary-image-9',
        'post_type' => 'page'
    ) );

    new MultiPostThumbnails(array(
        'label' => 'Persona 10 Image',
        'id' => 'secondary-image-10',
        'post_type' => 'page'
    ) );

    new MultiPostThumbnails(array(
        'label' => 'Persona 11 Image',
        'id' => 'secondary-image-11',
        'post_type' => 'page'
    ) );

    new MultiPostThumbnails(array(
        'label' => 'Persona 12 Image',
        'id' => 'secondary-image-12',
        'post_type' => 'page'
    ) );
}